...
def main():
    ...
    parser.add_argument('--datasets', type=str, nargs='+', default=['pet', 'isic'],
    ...
    parser.add_argument('--pet_root', type=str, default='./data/OxfordPets',
                       help='Root directory for Oxford-IIIT Pet dataset')
    parser.add_argument('--pet_split', type=str, default='test',
                       help='Split for Oxford-IIIT Pet (trainval/test)')
    parser.add_argument('--pet_max_samples', type=int, default=0,
    ...
    parser.add_argument('--isic_split', type=str, default='test',
                       help='Split for ISIC dataset (default: test)')
    parser.add_argument('--isic_max_samples', type=int, default=500,
    ...
    # build config dicts
    dataset_roots = {}
    dataset_roots['pet'] = args.pet_root
    dataset_roots['isic'] = args.isic_root
    
    dataset_splits = {}
    dataset_splits['pet'] = args.pet_split
    dataset_splits['isic'] = args.isic_split
    
    dataset_max_samples = {}
    if args.pet_max_samples <= 0:
        dataset_max_samples['pet'] = None
    else:
        dataset_max_samples['pet'] = args.pet_max_samples
    if args.isic_max_samples <= 0:
        dataset_max_samples['isic'] = None
    else:
        dataset_max_samples['isic'] = args.isic_max_samples
